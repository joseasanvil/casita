...
void stateON(){ // Keep LED on
  setIntensityLED(255);
}

void stateDIM(){ // Dim LED on and off
  dimLED(0,255);
  dimLED(254,1);
}

void stateBLINK(){ // Blink LED with 1/2 a second intervals
  setIntensityLED(255);
  delay(500);
  setIntensityLED(0);
  delay(500);
...
void stateHORROR(){ // Simulate the LED to light like in a horror movie 
...
void stateCANDLE(){ // Simulate the LED to light like a candle
  int intensity = random(10, 255);
